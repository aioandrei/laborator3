...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Teacher teacher1 = new Teacher("Aio", "Andrei");
        Teacher teacher2 = new Teacher("Fecioru", "Ana");
        teacherRepo.create(teacher1);
        teacherRepo.create(teacher2);

        CourseRepo courseRepo = new CourseRepo();
        Course course1 = new Course("MAP", teacher1,2, 10 );
        Course course2 = new Course("DB", teacher1, 2, 10);
        Course course3  = new Course("FP", teacher2, 2, 11);
        ...
        Student student1 = new Student("Aio", "Bogdan", 110);
        Student student2 = new Student("Batinas", "Vasile", 125);
        Student student3 = new Student("Batinas", "Ioan", 118);
